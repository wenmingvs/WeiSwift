...
public class Constants {
    ...
    public static final String APP_SCOPE = "email,direct_messages_read,direct_messages_write,friendships_groups_read,friendships_groups_write,statuses_to_me_read,follow_app_official_microblog," + "invitation_write";
    ...
    public static final String WEICO_AUTH_URL = "https://open.weibo.cn/oauth2/authorize?"
            + "client_id=" + WEICO_APP_KEY
            + "&response_type=token&redirect_uri=" + WEICO_REDIRECT_URL
